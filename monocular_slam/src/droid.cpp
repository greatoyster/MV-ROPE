...
/* 
  TODO: we need to modify this code to optimize object pose information, make sure it is compatiable with previous camera pose only ba
    new param: torch::Tensor object_poses
    new param: object instance masks
    new param: object nocs predictions
*/
