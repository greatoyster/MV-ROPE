...
class PoseTrajectoryFiller:
    ...
    def __call__(self, image_stream):
        ...
        for stream_data in image_stream:
            tstamp, image, intrinsic = None, None, None
            if len(stream_data) == 3:
                tstamp, image, intrinsic = stream_data
            elif len(stream_data) == 4:
                tstamp, image, intrinsic, _ = stream_data
            else:
                NotImplemented()
